...
def load_data(path_root, dataset):
    ...
    if dataset == 'credit':
        ...
        label_number = 6000
        path_credit = path_root + "/data1/yuchen/Fair-GAD/dataset/credit"
    ...
    # Load german dataset
        ...
        label_number = 100
        path_german = path_root + "/data1/yuchen/Fair-GAD/dataset/german"
    ...
    # Load bail dataset
        ...
        predict_attr = "RECID"
        label_number = 100
        path_bail = path_root + "/data1/yuchen/Fair-GAD/dataset/bail"
        ...
        sens_idx = 0
        label_number = 1000
        path_sythetic = path_root + '/data1/yuchen/Fair-GAD/dataset/synthetic.mat'
        ...
        sens_number = 200
        seed = 20
        path="/data1/yuchen/Fair-GAD/dataset/pokec/"
        test_idx=False
